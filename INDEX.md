...
├── CLAUDE.md                   ← Guide for Claude Code (development assistant)
├── database/
...
### Option A: Using Claude Code (Recommended for Fast Development)

1. **Install Claude Code** (if not already installed)
2. **Open your project directory**
3. **Provide CLAUDE.md to Claude Code:**
   ```
   @CLAUDE.md I need to build this project. Read all the documentation 
   and start with the authentication system.
   ```
4. **Claude Code will:**
...
|------|-------------|-----------|
| INDEX.md | Package overview (you are here) | 5 min |
| CLAUDE.md | **Claude Code development guide** | 15 min |
